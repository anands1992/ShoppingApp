...
- (IBAction)buttonClicked:(id)sender
{
    ...
    {
        [self.delegate deleteButtonAction:button.tag];
    }
    else
    {
        [self.delegate addToCartButtonAction:button.tag];
    }
}
    ...
    switch (recognizer.state)
    {
        ...
        case UIGestureRecognizerStateEnded:
            if (self.startingRightLayoutConstraintConstant == 0) { //1
                ...
                //Cell was closing
                CGFloat buttonOnePlusHalfOfButton2 = CGRectGetWidth(self.deleteButton.frame) + (CGRectGetWidth(self.addToCartButton.frame) / 2); //4
...
{
    return CGRectGetWidth(self.frame) - CGRectGetMinX(self.addToCartButton.frame);
}
