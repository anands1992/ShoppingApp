...
+ (void)setStoredDispatchForClass:(Class<GTLRuntimeCommon>)dispatchClass
  ...
  @synchronized([GTLRuntimeCommon class]) {
    ...
    CFMutableDictionaryRef classDict =
      (__bridge CFMutableDictionaryRef) [gDispatchCache objectForKey:dispatchClass];
    if (classDict == nil) {
      ...
      [gDispatchCache setObject:(__bridge id)classDict
    ...
    if (selDict == nil) {
      selDict = [NSDictionary dictionaryWithObjectsAndKeys:
                 ...
                 nil];
      CFDictionarySetValue(classDict, sel, (__bridge const void *)(selDict));
    } else {
...
+ (BOOL)getStoredDispatchForClass:(Class<GTLRuntimeCommon>)dispatchClass
  ...
  @synchronized([GTLRuntimeCommon class]) {
    ...
    for (Class currClass = dispatchClass;
      ...
      CFMutableDictionaryRef classDict =
        (__bridge CFMutableDictionaryRef) [gDispatchCache objectForKey:currClass];
      if (classDict) {
